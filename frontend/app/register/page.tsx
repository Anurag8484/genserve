...
export default function RegisterPage() {
  ...
  const onRegister = (e: React.FormEvent) => {
    ...
    // Placeholder: wire to FastAPI or Next API route to create account.
    alert("Registration not wired to backend yet. Use Google Sign-In for now.");
  };
